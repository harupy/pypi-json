...
class TestPyPIJson:
    async def test_get_package(self, mock_package_response):
    ...
    async def test_get_release(self, mock_release_response):
        with aioresponses() as m:
            m.get(
    ...
    async def test_caching(self, mock_package_response):
        with aioresponses() as m:
            m.get(
                "https://pypi.org/pypi/requests/json",
                payload=mock_package_response,
    ...
    async def test_custom_base_url(self, mock_package_response):
        with aioresponses() as m:
            m.get(
    ...
    async def test_clear_cache(self, mock_package_response):
        with aioresponses() as m:
            m.get(
                "https://pypi.org/pypi/requests/json",
                payload=mock_package_response,
    ...
    async def test_no_cache(self, mock_package_response):
        with aioresponses() as m:
            m.get(
                "https://pypi.org/pypi/requests/json",
                payload=mock_package_response,
